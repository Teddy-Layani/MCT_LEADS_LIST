		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zcrmleadslist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zcrmleadslist-display": {
								"semanticObject": "zcrmleadslist",
								"action": "display",
								"description": "CRM: Sales Leads List",
								"title": "Sales Leads List",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zcrmleadslist",
									"url": sap.ui.require.toUrl("zcrmleadslist")
								}
							}
						}
					}
